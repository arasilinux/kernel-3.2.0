...
#include <linux/input/tca8418_keypad.h>    /*added by arasi on 11/01/2012*/
...
static struct i2c_board_info am335x_i2c2_boardinfo[] = {
	     ...
	     {
                I2C_BOARD_INFO("tca8418_keypad", 0x34), /*********************added by arasi on 11/01/2013****************/
...
static void i2c2_init(int evm_id, int profile)
{
	...
	printk("%s func \n",__func__);
	printk("%s arasi tca8418 function func \n",__func__);
